...
class Plant:
    ...
    def build_numbers_attributs(self, max_bounds):
        self.hp = 100
        self.armor = random_used_value(1, self.hp)
        self.smart = random_used_value(1, max_bounds)
        self.speed = random_used_value(1, max_bounds)
...
class Battle:
    def __init__(self, plant1, plant2,
                 max_turns=1000,                # Número máximo de turnos antes de declarar empate
                 luck_factor=10,               # Quanto maior, menor o impacto da sorte na esquiva
                 miss_cap=0.9,                 # Limite máximo de chance de esquiva (ex: 90%)
                 attack_scale=0.1,             # Escala de dano com base no valor de ataque
...
# Criando duas plantas
plant1 = Plant()
plant1.build_names()
plant1.build_numbers_attributs(max_bounds=10)

plant2 = Plant()
plant2.build_names()
plant2.build_numbers_attributs(max_bounds=10)
